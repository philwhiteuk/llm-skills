...
| Skill | Description |
|-------|-------------|
| [spec](skills/spec/SKILL.md) | Write solution-agnostic specifications from raw input and classify them as a Story, Task, Spike, Bug, or Epic — rendered in the correct standardised format for sharing with the team. Refactoring and infrastructure work is always classified as a Task. |
